	...
	for(var i=0;i<data.length;i++){
		var cartItem = `
			<tr class="cotnay"> 
				...
				<td>
					<input class='nutgiam' type='button' value='-' data-product-code='" + val.ID + "'/>
					<input class= 'txtsoluong' type = 'text' value='" + val.SL + "' />
					<input class='nuttang' type='button' value='+' data-product-code='" + val.ID + "'/>
				</td >
